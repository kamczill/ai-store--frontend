...
const Header = () => {
  return (
    ...
    <div className='flex flex-col gap-5 px-10 max-w-[700px]'>
      <h1 className='font-poppins font-bold text-3xl text-center leading-relaxed xl:text-5xl'><span className='text-green-500'>AI</span> nie zabierze Ci pracy, <span className='text-green-500'>AI</span> da Ci pracę!!</h1>
